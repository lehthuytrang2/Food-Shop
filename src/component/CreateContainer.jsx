...
import { saveItem } from '../utils/firebaseFuctions';
  ...
  return (
    <div className='flex w-full min-h-screen items-center justify-center'>
      <div className="w-[90%] md:w-[75%] border-gray-300 rounded-lg p-4 items-center justify-center flex flex-col">
        {
          fields && (
            <p className={`w-full text-lg font-semibold text-center p-2  rounded-lg ${alertStatus === 'danger'     // toán tử ba ngôi
        ...
        {/* calo va gia */}
        <div className="flex flex-col md:flex-row w-full items-center mt-3">
          {/* calories */}
